...
export function Header() {
  ...
  // Theme toggle needs to be mounted to avoid hydration mismatch
  useEffect(() => {
    setMounted(true)
  }, [])
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-transparent py-4">
        <div className="container mx-auto px-4 flex items-center justify-between">
          ...
          <div className="hidden md:block">
            <div className="h-6 w-48" /> {/* Placeholder for nav */}
          </div>
          <div className="h-8 w-8" /> {/* Placeholder for theme toggle */}
        </div>
      </header>
    )
  }
